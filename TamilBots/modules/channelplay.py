...
from Cyber.modules.play import generate_cover
from Cyber.modules.play import arq
from Cyber.modules.play import cb_admin_check
from Cyber.modules.play import transcode
from Cyber.modules.play import convert_seconds
from Cyber.modules.play import time_to_seconds
from Cyber.modules.play import changeImageSize
...
async def play(_, message: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<i> {user.first_name} Userbot not in this chat, Ask channel admin to send /join command for first time or add {user.first_name} manually</i>"
        )
        return
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add your assistent to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
        ...
        await lel.edit(
            "<i> helper Userbot not in this channel, Ask channel admin to send /join command for first time or add assistant manually</i>"
        )
        return
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/7fb842a7a7791ff75489b.png"
